  ...
  return (
    <section className="w-full bg-[#EAEAEA] py-20 px-6 md:px-16 lg:px-24 text-neutral-900 border-t border-neutral-200">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        {/* الجزء الشمال: النص التعريفي والزرار */}
        <div className="flex flex-col items-start space-y-8 max-w-xl">
          ...
          <button className="border border-neutral-900 px-8 py-3 text-xs uppercase tracking-widest font-semibold hover:bg-neutral-900 hover:text-white transition duration-300">
            LEARN MORE
          </button>
        </div>

        {/* الجزء اليمين: صورة الموديلز */}

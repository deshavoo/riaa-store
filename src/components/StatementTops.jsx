...
import top1 from "../assets/product1.jpg";
import top2 from "../assets/product2.jpg";
import top3 from "../assets/product3.jpg";
import top4 from "../assets/product4.jpg";
import sideModel from "../assets/Hero.jpg";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mb-20 bg-white">
        ...
        <div className="flex flex-col items-center justify-center p-8 text-black text-center font-agency">
          ...
          <div className="flex items-center space-x-4">
            <button className="bg-black text-white px-6 py-2.5 text-xs font-bold uppercase tracking-widest hover:bg-gray-800 transition rounded-lg">
              SHOP NOW
            </button>
            <button className="border border-black bg-transparent px-6 py-2.5 text-xs font-bold uppercase tracking-widest hover:bg-black hover:text-white transition rounded-lg">
              Explore look
            </button>
          </div>
        </div>
